...
<section class="yourInfo mb-2 row">
    <h4>Your Info</h4>
    <div class="ipo m-2 col-sm-2 col-4">
    ...
    <div class="watchlist m-2 col-sm-2 col-4">
    ...
    <div class="portfolio m-2 col-sm-2 col-2">
...
<section class="nepse mb-2 row">
    <h4>Market Info</h4>
    <div class="liveMarket m-2 col-sm-2 col-4">
